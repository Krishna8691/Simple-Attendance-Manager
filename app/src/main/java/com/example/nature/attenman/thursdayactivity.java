...
public class thursdayactivity extends AppCompatActivity {
    ...
    DBHelperThursday mDatabaseHelper;
    private Button btnAdd, btnViewData;
    private EditText editText;

    DBHelperThursday mmDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thursdayactivity);
        ...
        mDatabaseHelper = new DBHelperThursday(this);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(thursdayactivity.this, ListDataActivitythursday.class);
        ...
        mmDatabaseHelper = new DBHelperThursday(this);
        //populateListViewmv();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(thursdayactivity.this, EditDataActivity.class);
