...
public class ListDataActivitytuesday extends AppCompatActivity {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(ListDataActivitytuesday.this, EditDataActivityTuesday.class);
