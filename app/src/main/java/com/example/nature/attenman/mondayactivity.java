...
public class mondayactivity extends AppCompatActivity {
    ...
    DatabaseHelper mmDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mondayactivity);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mondayactivity.this, ListDataActivity.class);
        ...
        mmDatabaseHelper = new DatabaseHelper(this);
        //populateListViewmv();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(mondayactivity.this, EditDataActivity.class);
