...
public class tuesdayactivity extends AppCompatActivity {
    ...
    DBHelperTuesday mmDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuesdayactivity);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tuesdayactivity.this, ListDataActivitytuesday.class);
        ...
        mmDatabaseHelper = new DBHelperTuesday(this);
        //populateListViewmv();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(tuesdayactivity.this, EditDataActivityTuesday.class);
