...
public class TodayMondayActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_monday);
    ...
    private void populateListView() {
        ...
        //customlistmain customList = new customlistmain(this, listData);
