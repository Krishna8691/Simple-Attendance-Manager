...
public class saturdayactivity extends AppCompatActivity {
    ...
    DBHelperSaturday mDatabaseHelper;
    private Button btnAdd, btnViewData;
    private EditText editText;

    DBHelperSaturday mmDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saturdayactivity);
        ...
        mDatabaseHelper = new DBHelperSaturday(this);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(saturdayactivity.this, ListDataActivitySaturday.class);
        ...
        mmDatabaseHelper = new DBHelperSaturday(this);
        //populateListViewmv();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(saturdayactivity.this, EditDataActivitySaturday.class);
