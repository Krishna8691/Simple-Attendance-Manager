...
public class fridayactivity extends AppCompatActivity {
    ...
    DBHelperFriday mDatabaseHelper;
    private Button btnAdd, btnViewData;
    private EditText editText;

    DBHelperFriday mmDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fridayactivity);
        ...
        mDatabaseHelper = new DBHelperFriday(this);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(fridayactivity.this, ListDataActivityfriday.class);
        ...
        mmDatabaseHelper = new DBHelperFriday(this);
        //populateListViewmv();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(fridayactivity.this, EditDataActivity.class);
